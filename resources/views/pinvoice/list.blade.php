...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="">
           <label class="bold py-4" style="margin-left: 20px" >Proforma Invoices</label>
           ...
           <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$value->status}}</td>
                  <td>
                    <a href="{{route('performa_invoice_details',$value->id)}}"><button class="btn btn-sm btn-warning text-white">View</button></a>
                  </td>
                </tr>
